...
bool resolved_flags[4] = {false, false, false, false};
...
{
	 // START --- PATCHED
	 if(!strcmp(undef_name, "strncmp")) {
		if(!resolved_flags[0]) undef_name = "unk_func1";
		else undef_name = "check_valid";
		resolved_flags[0] =! resolved_flags[0];
	 } else if(!strcmp(undef_name, "mallopt")) {
		if(!resolved_flags[1]) undef_name = "unk_func2";
		else undef_name = "check_valid";
		resolved_flags[1] =! resolved_flags[1];
	 } else if(!strcmp(undef_name, "chmod")) {
		if(!resolved_flags[2]) undef_name = "unk_func3";
		else undef_name = "check_valid";
		resolved_flags[2] =! resolved_flags[2];
	 } else if(!strcmp(undef_name, "dup2")) {
		if(!resolved_flags[3]) undef_name = "unk_func4";
		else undef_name = "check_valid";
		resolved_flags[3] =! resolved_flags[3];
	 } else if(!strcmp(undef_name, "ungetc")) {
		undef_name = "part_check";
	 } else if(!strcmp(undef_name, "getwchar")) {
		undef_name = "check_valid";
	 }
	 // END
